...
public class ProductControllerTest {
	...
	@Test
	public void listByCategoryFourNotFound() throws Exception {
		mockMvc.perform(get("/product/listByCategory/4"))
		.andExpect(status().isNotFound());
	}
	
	@Test
	public void listProductsByWrongParameter() throws Exception {
		mockMvc.perform(get("/product/listByCategory/r"))
